...
const (
	Subject_PaymentProcessed Subject = 0
	Subject_OrderCreated     Subject = 1
)
...
func (x *PayloadUserCharge) Reset() {
	*x = PayloadUserCharge{}
	if protoimpl.UnsafeEnabled {
...
func (x *PayloadUserCharge) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PayloadUserCharge) ProtoMessage() {}

func (x *PayloadUserCharge) ProtoReflect() protoreflect.Message {
	mi := &file_common_event_event_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PayloadUserCharge.ProtoReflect.Descriptor instead.
func (*PayloadUserCharge) Descriptor() ([]byte, []int) {
	return file_common_event_event_proto_rawDescGZIP(), []int{1}
}

func (x *PayloadUserCharge) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *PayloadUserCharge) GetAmount() float32 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *PayloadUserCharge) GetOrderId() string {
	if x != nil {
		return x.OrderId
	}
	return ""
...
func (x *PayloadUserCharge) GetSubject() Subject {
	if x != nil {
		return x.Subject
	}
	return Subject_PaymentProcessed
}
...
var file_common_event_event_proto_rawDesc = []byte{
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x89, 0x01, 0x0a, 0x11, 0x50, 0x61,
	0x79, 0x6c, 0x6f, 0x61, 0x64, 0x55, 0x73, 0x65, 0x72, 0x43, 0x68, 0x61, 0x72, 0x67, 0x65, 0x12,
	...
	,
...
var file_common_event_event_proto_goTypes = []interface{}{
	...
	(*PayloadUserCharge)(nil), // 2: event.PayloadUserCharge
...
var file_common_event_event_proto_depIdxs = []int32{
	...
	0, // 1: event.PayloadUserCharge.subject:type_name -> event.Subject
...
func file_common_event_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_common_event_event_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PayloadUserCharge); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
