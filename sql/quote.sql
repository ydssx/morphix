CREATE TABLE quotes (
    ...
    date TIMESTAMP NOT NULL COMMENT '报价日期',           -- 报价日期
...
CREATE TABLE coupons (
    ...
    discount_type ENUM('percentage', 'amount') NOT NULL COMMENT '优惠券类型',  -- 折扣类型：百分比、固定金额
...
CREATE TABLE user_coupons (
    ...
    used BOOLEAN DEFAULT FALSE COMMENT '是否已使用',        -- 是否已使用
    used_date TIMESTAMP COMMENT '使用日期',               -- 使用日期
