...
func (m *Bootstrap) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetSmsRpc()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, BootstrapValidationError{
					field:  "SmsRpc",
	...
	} else if v, ok := interface{}(m.GetSmsRpc()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return BootstrapValidationError{
				field:  "SmsRpc",
				reason: "embedded message failed validation",
...
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *SmsRpc) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SmsRpc with the rules defined in the
// proto definition for this message. If any rules are violated, the result is
// a list of violation errors wrapped in SmsRpcMultiError, or nil if none found.
func (m *SmsRpc) ValidateAll() error {
	return m.validate(true)
}

func (m *SmsRpc) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return SmsRpcMultiError(errors)
	}

	return nil
}

// SmsRpcMultiError is an error wrapping multiple validation errors returned by
// SmsRpc.ValidateAll() if the designated constraints aren't met.
type SmsRpcMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SmsRpcMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SmsRpcMultiError) AllErrors() []error { return m }

// SmsRpcValidationError is the validation error returned by SmsRpc.Validate if
// the designated constraints aren't met.
type SmsRpcValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SmsRpcValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SmsRpcValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SmsRpcValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SmsRpcValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SmsRpcValidationError) ErrorName() string { return "SmsRpcValidationError" }

// Error satisfies the builtin error interface
func (e SmsRpcValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = SmsRpcValidationError{}
