...
const (
	...
	// QuoteServiceGetUserCouponsProcedure is the fully-qualified name of the QuoteService's
	// GetUserCoupons RPC.
	QuoteServiceGetUserCouponsProcedure = "/quote.QuoteService/GetUserCoupons"
	// QuoteServiceUseCouponProcedure is the fully-qualified name of the QuoteService's UseCoupon RPC.
	QuoteServiceUseCouponProcedure = "/quote.QuoteService/UseCoupon"
)
...
func NewQuoteServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) QuoteServiceClient {
	...
	return &quoteServiceClient{
		...
		getUserCoupons: connect_go.NewClient[v1.GetUserCouponsRequest, v1.GetUserCouponsResponse](
			httpClient,
			baseURL+QuoteServiceGetUserCouponsProcedure,
			opts...,
		),
		useCoupon: connect_go.NewClient[v1.UseCouponRequest, v1.UseCouponResponse](
			httpClient,
			baseURL+QuoteServiceUseCouponProcedure,
			opts...,
		),
	}
}
...
// GetUserCoupons calls quote.QuoteService.GetUserCoupons.
func (c *quoteServiceClient) GetUserCoupons(ctx context.Context, req *connect_go.Request[v1.GetUserCouponsRequest]) (*connect_go.Response[v1.GetUserCouponsResponse], error) {
	return c.getUserCoupons.CallUnary(ctx, req)
}

// UseCoupon calls quote.QuoteService.UseCoupon.
func (c *quoteServiceClient) UseCoupon(ctx context.Context, req *connect_go.Request[v1.UseCouponRequest]) (*connect_go.Response[v1.UseCouponResponse], error) {
...
func NewQuoteServiceHandler(svc QuoteServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	quoteServiceGetUserCouponsHandler := connect_go.NewUnaryHandler(
		QuoteServiceGetUserCouponsProcedure,
		svc.GetUserCoupons,
		opts...,
	)
	quoteServiceUseCouponHandler := connect_go.NewUnaryHandler(
		QuoteServiceUseCouponProcedure,
		svc.UseCoupon,
		opts...,
	)
	return "/quote.QuoteService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case QuoteServiceGetUserCouponsProcedure:
			quoteServiceGetUserCouponsHandler.ServeHTTP(w, r)
		case QuoteServiceUseCouponProcedure:
			quoteServiceUseCouponHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedQuoteServiceHandler) GetUserCoupons(context.Context, *connect_go.Request[v1.GetUserCouponsRequest]) (*connect_go.Response[v1.GetUserCouponsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("quote.QuoteService.GetUserCoupons is not implemented"))
}

func (UnimplementedQuoteServiceHandler) UseCoupon(context.Context, *connect_go.Request[v1.UseCouponRequest]) (*connect_go.Response[v1.UseCouponResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("quote.QuoteService.UseCoupon is not implemented"))
}
